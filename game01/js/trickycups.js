...
Copyright 2009 - 2016, Novel Games Limited.

Unauthorized redistribution of the game is
strictly prohibited.

Decompiling, reverse engineering, and
modification of the game is also strictly
prohibited.
...
(function () {
    ...
    window.nogic = f;
    f.platform.Preload = function (a, b, d, c, e, f, h, g, j, k, m) {
        this.parameters = f;
        null == this.parameters && (this.parameters = {});
        this.extraParameters = h;
        null == this.extraParameters && (this.extraParameters = {});
        this.extraParameters.forceCoversWholeBrowser ? (a.style.position =
            "absolute", a.style.left = "0px", a.style.top = "0px", a.width = document.documentElement.clientWidth, a.height = document.documentElement.clientHeight) : this.extraParameters.forceCanvasSize && (a.width = a.clientWidth, a.height = a.clientHeight);
        this.canvas = a;
        ...
        this.backgroundOutsideColor = e;
        this.backgroundOutsideFillStyle = "rgba(" + (e >>> 16 & 255) + "," + (e >>> 8 & 255) + "," + (e & 255) + "," + (e >>> 24 & 255) / 255 + ")";
        this.canvasWidth =
            a.width;
        this.canvasHeight = a.height;
        this.canvasClientWidth = a.clientWidth;
        this.canvasClientHeight = a.clientHeight;
        this.createScreenTransform(b, d, a.width, a.height, a.clientWidth, a.clientHeight);
        this.filesFolder = g;
        this.useMergedAssets = j;
        this.mergedJavaScriptsPath = k;
        this.splashScreenPath = m
    };
    f.platform.Preload.prototype.createScreenTransform = function (a, b, d, c, e, l) {
        var h;
        d = e / d;
        c = l / c;
        h = new f.platform.Preload.Matrix;
        h.scale(d, c);
        c = h.createInverse();
        d = Math.min(e / a, l / b);
        a = (e - d * a) / 2;
        b = (l - d * b) / 2;
        this.overallTransform =
            new f.platform.Preload.Matrix;
    ...
    f.platform.Preload.prototype.checkBrowser =
        function () {
    ...
    f.platform.Preload.prototype.showSplashScreen = function () {
        ...
        this.canvasContext.fillStyle = this.backgroundOutsideFillStyle;
    ...
    f.platform.Preload.prototype.loadNormalSplashScreen = function () {
        var a = this, b, d, c;
        null == this.splashScreenPath ?
            this.loadSplashScreenFinished(!1, b) : (d = function () {
    ...
    f.platform.Preload.prototype.loadMergedSplashScreen = function () {
        ...
        }, b = new Image, b.crossOrigin =
            "Anonymous", b.onload = d, b.onerror = c, b.onabort = c, b.src = this.splashScreenPath)
    };
    f.platform.Preload.prototype.loadMergedSplashScreenFinished = function (a, b) {
        var d = this, c, e, f, h, g, j, k;
        if (a) {
            j = function () {
            ...
            for (e = 0; e < c.length;) {
                ...
                g.onerror =
                    k;
                g.onabort = k;
                g.src = "data:image/png;base64," + this.base64Encode(c, e, h);
                e += h
            }
    ...
    f.platform.Preload.prototype.readDataFromImagePixels = function (a, b) {
        ...
        c = this.readDataFromImageData(e, d.width, d.height, b, 9, f);
        d = this.calculateCRC32(c);
        return h != d ? this.readDataFromImagePixels(a, b + 2) : c
    };
    f.platform.Preload.prototype.readDataFromImageData = function (a, b, d, c, e, f) {
        ...
        h = 3 * (b / c);
        j = Array(f);
        g = 4 * d + e % h % 3 + 4 * Math.floor(e % h / 3) * c;
        e = d + Math.floor(e / h) * c;
        for (k =
                 0; k < f; k++) h = 4 * e * b + g, j[k] = a.data[h], g++, 3 == g % 4 && (g += 4 * (c - 1) + 1), g >= 4 * b && (g = 4 * d, e += c);
        return j
    };
    ...
    f.platform.Preload.prototype.loadSplashScreenFinished =
        function (a, b) {
            var d = this;
    ...
    f.platform.Preload.prototype.checkCanvasResize = function () {
        if (this.extraParameters.forceCoversWholeBrowser && (this.canvas.width !=
            document.documentElement.clientWidth || this.canvas.height != document.documentElement.clientHeight)) this.canvas.width = document.documentElement.clientWidth, this.canvas.height = document.documentElement.clientHeight;
        this.canvas.width == this.canvasWidth && this.canvas.height == this.canvasHeight && this.canvas.clientWidth == this.canvasClientWidth && this.canvas.clientHeight == this.canvasClientHeight || (this.canvasContext.save(), this.canvasContext.fillStyle = this.backgroundOutsideFillStyle, this.canvasContext.fillRect(0,
            0, this.canvas.width, this.canvas.height), this.canvasContext.restore(), this.createScreenTransform(this.width, this.height, this.canvas.width, this.canvas.height, this.canvas.clientWidth, this.canvas.clientHeight), this.drawSplashScreenImage(), this.canvasWidth = this.canvas.width, this.canvasHeight = this.canvas.height, this.canvasClientWidth = this.canvas.clientWidth, this.canvasClientHeight = this.canvas.clientHeight)
    };
    f.platform.Preload.prototype.loadMergedJavaScripts = function () {
        var a = this, b, d;
        if (".js" == this.mergedJavaScriptsPath.substr(this.mergedJavaScriptsPath.length -
            3)) {
            try {
    ...
    f.platform.Preload.prototype.loadMergedJavaScriptsJSFinished = function (a) {
        ...
        this.mainClass.preloadAssets(this.filesFolder, this.useMergedAssets, this.canvas, this.width, this.height, this.backgroundColor, this.backgroundOutsideColor, this.parameters, this.extraParameters, this.programEntryPointClassName, function () {
    ...
    f.platform.Preload.prototype.loadMergedJavaScriptsPNGFinished = function (a) {
        ...
        this.mainClass.preloadAssets(this.filesFolder, this.useMergedAssets,
            this.canvas, this.width, this.height, this.backgroundColor, this.backgroundOutsideColor, this.parameters, this.extraParameters, this.programEntryPointClassName, function () {
                b.preloadAssetsFinished()
            })
    };
    ...
    f.platform.Preload.prototype.utf8BytesToString = function (a, b, d) {
        var c = "", e, f, h, g;
        for (g = b; g < b + d; g++) e = a[g], 224 <= e ?
            (f = a[++g], h = a[++g], e = (e & 15) << 12 | (f & 63) << 6 | h & 63) : 127 < e && (f = a[++g], e = (e & 31) << 6 | f & 63), c += String.fromCharCode(e);
        return c
    };
    f.platform.Preload.prototype.base64Encode = function (a, b, d) {
        var c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split(""), e, f, h, g, j;
        e = "";
        for (j = b; j < b + d; j += 3) f = a[j], h = j + 1 < b + d ? a[j + 1] : 0, g = j + 2 < b + d ? a[j + 2] : 0, e += c[f >> 2], e += c[(f & 3) << 4 | h >> 4], e += j + 1 < b + d ? c[(h & 15) << 2 | g >> 6] : "=", e += j + 2 < b + d ? c[g & 63] : "=";
        return e
    };
    ...
    f.platform.Preload.Matrix.prototype.preConcatenate =
        function (a) {
    ...
    f.initialize = function (a, b, d) {
        ...
        e = c + "/assets/__.png";
        l = c + "/assets/_.png";
        null == d || null == d.backgroundColor ? h = -1 : (g = parseInt(d.backgroundColor.substr(1, 2), 16), j = parseInt(d.backgroundColor.substr(3, 2), 16), k = parseInt(d.backgroundColor.substr(5, 2), 16), h = 4278190080 | g << 16 | j << 8 | k);
        null == d || null == d.backgroundOutsideColor ? g = -16777216 : (g = parseInt(d.backgroundOutsideColor.substr(1, 2), 16), j = parseInt(d.backgroundOutsideColor.substr(3,
            2), 16), k = parseInt(d.backgroundOutsideColor.substr(5, 2), 16), g = 4278190080 | g << 16 | j << 8 | k);
        m = new f.platform.Preload(a, 600, 400, h, g, b, d, c, !0, e, l);
        m.initialize("com.novelgames.spgames.trickycups.Main");
        return {
